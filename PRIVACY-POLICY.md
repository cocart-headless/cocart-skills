...
- No usage analytics or telemetry are recorded
- No API keys, credentials, or project files are accessed
- No cookies or local storage are used
- No third-party tracking is employed

## Third-party services

The plugin references links to external documentation hosted at:

- [cocartapi.com](https://cocartapi.com) — CoCart documentation
- [github.com/cocart-headless](https://github.com/cocart-headless) — CoCart SDK repositories
